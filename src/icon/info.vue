<template>
    <svg :class="svgClass" :style="{ color: color, width, height }" :width="width" :height="height" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="4683">
        <path
            ...
            fill="currentColor" p-id="4684"></path>
    </svg>
</template>
